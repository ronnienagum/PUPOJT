...
<head>
<meta charset="utf-8">
<title> PUP OJT / <?php echo $title;?></title>
...
<div id="wrapper" class="home-page">
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"> <i class="fa fa-phone"></i> Phone: (+63 2) 5335-1 PUP (5335-1787) or 5335-1777 </p>
                <p class="pull-left hidden-xs"> <i class="fa fa-envelope"></i> Email: inquire@pup.edu.ph </p>
                <?php if (isset($_SESSION['APPLICANTID'])) { 
                    ...
                    echo ' <p class="pull-right login"><a title="View Profile" href="'.web_root.'applicant/"> <i class="fa fa-user"></i> '. $appl->FNAME. ' '.$appl->LNAME .' </a> | <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> </p>';

                    } else if(isset($_SESSION['COMPANYID'])) {
                      $company = new Company();
                      $com  = $company->single_company($_SESSION['COMPANYID']);

                      echo ' <p class="pull-right login"><a title="View Profile" href="'.web_root.'company/"> <i class="fa fa-user"></i> '. $com->COMPANYNAME .' </a> | <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> </p>';
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- <a class="navbar-brand" href="<?php echo web_root; ?>index.php"> <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/></a> -->
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php"> PUP - Job Portal</a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="<?php echo web_root; ?>index.php">Home</a></li> 
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='advancesearch'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=advancesearch">Job Search</a></li> 
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='company'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=company">Partners</a></li>
  ...
  <?php
    if (!isset($_SESSION['APPLICANTID']) && !isset($_SESSION['COMPANYID'])) { 
      include("./login.php");
    }
  ?>
      <?php
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            ...
            <li><a href="<?php echo web_root; ?>index.php?q=company">Partners</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; 1998-2021 POLYTECHNIC UNIVERSITY OF THE PHILIPPINES
            </p>
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="social-network">
            <li><a href="https://www.facebook.com/ThePUPOfficial" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="https://twitter.com/ThePUPOfficial" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://www.linkedin.com/school/polytechnic-university-of-the-philippines/" data-placement="top" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
