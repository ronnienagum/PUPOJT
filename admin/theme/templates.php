...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>PUP OJT</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PUP OJT</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
       ...
       <!--  <li class="treeview">
        ...
        <!-- <li class="<?php echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/userfeedback/">
            <i class="fa fa-comments"></i> <span>Feedback</span> </a>
        </li> -->
