            ...
            <div class="box-header with-border">
              ...
              <div class="form-group">
                <div class="col-md-11">
                  ...
                  <div class="col-md-8">
                   <div class="col-lg-5">
                      <div class="radio">
                        <label><input checked id="optionsRadios1"	<?php echo ($appl->SEX=='Female') ? 'checked="True"': '';?> checked="True" name="optionsRadios" type="radio" value="Female">Female</label>
                      </div>
                    </div>

                    <div class="col-lg-4">
                      <div class="radio">
                        <label><input id="optionsRadios2"	<?php echo ($appl->SEX=='Male') ? 'checked="True"': '';?>  name="optionsRadios" type="radio" value="Male"> Male</label>
                      </div>
                    </div> 
                ...
                <div class="col-md-11">
                  ...
                  <div class="col-md-8">
                    <select class="form-control input-sm" name="CIVILSTATUS" id="CIVILSTATUS">
                        <option value="none" <?php echo ($appl->CIVILSTATUS=='Male') ? 'selected="selected"': '';?> >Select</option>
                        <option value="Single" <?php echo ($appl->CIVILSTATUS=='Single') ? 'selected="selected"': '';?> >Single</option>
                        <option value="Married" <?php echo ($appl->CIVILSTATUS=='Married') ? 'selected="selected"': '';?> >Married</option>
                        <option value="Widow" <?php echo ($appl->CIVILSTATUS=='Widow') ? 'selected="selected"': '';?>>Widow</option>
                    </select> 
                  </div>
                </div>
              </div>  
              ...
              <div class="form-group">
                <div class="col-md-11">
                  ...
                  <div class="col-md-8">
                     <button class="btn btn-primary btn-sm" name="submit" type="submit" ><span class="fa fa-save"></span> Update </button>
                    </div>
                </div>
              </div>  
